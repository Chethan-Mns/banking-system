...
?>
	...
	<div class="container">
            ...
            <form method="post" name="tcredit" class="tabletext" ><br>
                ...
                <h2 class="text-center " style="color : #6c757d;">
                <?php echo "Welcome"; echo " "; echo $rows['name'];?>
                </h2><br>
        ...
        <div class="col-6">
            ...
            <button class="btn btn-primary" name="submit" type="submit" id="myBtn" >Proceed</button>
            </div>
        </form>
    </div>
    <footer class="text-center mt-5 py-2">
            <p>&copy Made by M.N.S.CHETHAN</b></p>
    </footer>
